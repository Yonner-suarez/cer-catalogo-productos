...
using microCatalagoProductos.API.Model.Request.Validators;
using microCatalagoProductos.API.Utils;
using microCatalagoProductos.API.Utils.Filters;
...
// Configuraci�n del entorno y variables
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Version = "v1",
        Title = "Microservicio Cat�logo de Productos"
    });
});
